...
const Footer = ({footerRef, smoothY}) => {
    ...
    return (
        <div className={`z-30 relative ${pathname === "/alldesigns/logodesigns" ? "bg-bodybg text-darkbg border-darkbg" : "bg-darkbg text-text_gray border-text_gray"}`}>
            <motion.footer ref={footerRef} style={{y: smoothY}} className={`z-30 md:px-32 px-4 py-16 ${pathname === "/alldesigns/logodesigns" ? "bg-bodybg text-darkbg border-darkbg" : "bg-darkbg text-text_gray border-text_gray"}`}>
