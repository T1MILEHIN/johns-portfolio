...
const NavBar = () => {
    ...
    return (
        <header className={`z-[999] fixed w-full top-0 right-0 flex justify-between items-center md:p-8 p-4 ${pathname === "/contact" ? "bg-darkbg" : "bg-transparent"}`}>
            ...
            <AnimatePresence>
                {(pathname === "/" || pathname === "/graphics") &&
                    <motion.div className="z-10" initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0, transition: { type: "spring", stiffness: 200 } }} exit={{ opacity: 0, y: -100 }}>
