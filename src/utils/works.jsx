...
import abflexLanding from "../assets/images/all-single-products/abflex-landing.png"
import abflex2 from "../assets/images/all-single-products/abflex2.jpg"
import abflex3 from "../assets/images/all-single-products/abflex3.jpg"
import abplace1 from "../assets/images/all-single-products/abbi1.jpg"
import abplace2 from "../assets/images/all-single-products/abbi2.jpg"
import abplace3 from "../assets/images/all-single-products/abbi3.jpg"

import truecallerLanding from "../assets/images/all-single-products/trueLanding.jpg"
import true1 from "../assets/images/all-single-products/true1.png"
import true2 from "../assets/images/all-single-products/true2.png"
import true3 from "../assets/images/all-single-products/true3.jpg"
...
export const Works = [
    {
        ...
        singleDetails: {
            ...
            absoluteImage: false,
            absoluteVideo: "https://s3-figma-videos-production-sig.figma.com/video/1291652978203910326/TEAM/5cb3/b08b/-3ff7-49ac-9fcd-8357090a6c14?Expires=1748217600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Wwox-wzhTj2mZTPVPdRf7kkZIgS0Q1Mizxnr708NzRtBBbZk8bujCn3Mvm~CxIHMr3ej-JEZWXgJ3wITkeInirhmMY~juhRNDRDqA7Nj0HhBGqsBm5ndlnHdh-ONjkRcgfwDuxqH-z5PgFkCR9py4s9EieRB6o4mD3qvVNVvVMpqxaoa5VvWkN9s6FE4cH3E3W1U8-EwlLK9Fwnopyr-7oRQDAuMBCD~Zgz0NEjbaJBbvFGbmVPrvQnXp9NwQyizyiX1wDWL7oZPlUZJ79Lc15FiS858NiieI-1NpHfWFGkEVO-OdVGSwa-S3~oictNP9-J7JORs61hiCxIafwb1Mw__",
            videoBg: "#DDE8FF",
    ...
    },
    {
        ...
        singleDetails: {
            ...
            absoluteImage: false,
            absoluteVideo: "https://s3-figma-videos-production-sig.figma.com/video/1291652978203910326/TEAM/e495/6c13/-fbb2-475e-a1a4-efec4a1b7306?Expires=1748217600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=mrmQmaNHEccYQqP-UYezq7kzwRMttwERzUJZDeyl614ESiPjMrwAOhMUURa24QpUU~kdVKv5kq6hePNVNOzazz0DmvzZX~bxrgRAvC3HoXYtXPf53lLeW~KhK8aiB3sirXB9lFoM9Fft7VouKyBZVdPtQT3Bvag6-FPtsGDFIyF1-ZE6FyVC-vmGc1vjgBTEvA6xwlFfXuA4SgK5U8BPseFA2hcDF25KrT0ohrzo3ZwTN2X2z5UL9cf0SzOPo9mKKPRjFF-RoNAKQdCULben8WAIy-MemoUXqG8gjAGuBGE09UaXG6p9NF--g~os7uOgLzuTeo3IQBgzDSqXL59dlw__",
            videoBg: "#D9D9D9",
    ...
    },
    {
        ...
        singleDetails: {
            ...
            videoBg: "#DDE8FF",
            absoluteImage: false,
            absoluteVideo: "https://s3-figma-videos-production-sig.figma.com/video/1291652978203910326/TEAM/6cbe/4d8d/-33b8-4d88-b785-ee059e1b300b?Expires=1748217600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Mepvp4sIdTEu1ScDw0x2nEK010Njr2b3rlIFCdhfYeLSR9ImstI7iSBTDddNa~fGNABShIlKTJoajUEOh6yYDDWlDdtWpxdg2Ycuva2UPt96O8h1HJeZ5xIlqj0BPsYGZlM6mMPUva0oWqAD6Gu4JKLSQusKFSFylIHUxO-bIcLIruVTA3A7LIGf8umpwsJw7vu3tqGkZsSCqTRIDemyBOJn1FYcGl0OX2Mn6ZcqGHVqO438MwR~Z-FcH4fVqflPS-ih4Wy7hcxvkv6umkmmiHJJNvMdSFBZx4VbuOCWvFyVwZt7ccbI7ls3VbkVRBAqkcLEZ2D0zhq6VAxZpnQ1sg__",
            ...
            video: "https://s3-figma-videos-production-sig.figma.com/video/1291652978203910326/TEAM/b3f5/b1bd/-0244-440b-9158-3fe489ab172e?Expires=1748217600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=J2zgZmOZ30nVjHrD6x0GHzmBVE8exFRRXzCRKeOpu72KKzVZ~bgIw8KvRPSoANVBrk6kTMsp9qE0WPWMgsZsPwwestYIcYxmgvaZdfL1gc9Q4of6zkKukDvA9YpYtdJnlb-SXinQ6XqPaiIkrAyffUAGh63z-zgmlzcQShm-v93ovwJegW4INsPzpOgZtgN6H3H4FCyFw6C5rlbLL5hCf~R9tfHPCxKSC1PAa3TESnORQYxr0mIKsTr56b6cYDGZIfLmKTIMMZQc-1l23D7WtPC693lx4w55YXtCWu803H9W7FNKejLS286CwPn5aIysOkRDYuihSOqlluX~V0CNqw__",
            objectives: [
    ...
    },
    {
        ...
        singleDetails: {
            ...
            video: "https://s3-figma-videos-production-sig.figma.com/video/TEAM/1291652978203910326/defd7ddc3342db55c16df9729b3d733d81b4fe93?Expires=1748217600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Yt94zXKj6VRgqIGJJzhOHYYttl-M9yDuVdKvwBKhfFYoDBRzOQLbJ052LkXn7HdVC7CF~FgC6dCFsm2rSYUDVgcommW1EpEOl1nkvFlt0x~3p2WcHlH9kjdy-k9wT1E~BGoQ4USxiEDa3W9l4t0eS0QNQMIOZXmjbOILCyZR7URvCkqWNu3Jgsnjs6kuJUNuXnMudnY02kv0cf7aU76sl5wYWaT5Vgifh-EmlizQjMubfqYcWlhG9YYLziztsYsb2Da8k7HDCLNhyUiyKABFNJy8pgizaJmQeaxPdxk60K7NmqVEzhaaTet48T8rViN-4B-EOQR~m8NPafVn6xKcxw__",
        }
    },
    {
        client: "SEEG Daily",
    ...
    },
    {
        ...
        singleDetails: {
            ...
            video: "https://s3-figma-videos-production-sig.figma.com/video/1291652978203910326/TEAM/3e97/34bb/-ebd3-40b9-9f8b-0acc5757166f?Expires=1748217600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=n5bRZLAdtPCCv6-lAoL3ab2roJ66knQhcmibyhsal8YoNiBD23zhje~dx9w6KV4TQblNq4SngG4MzzwXbcVSvTF6d-IPQ~ompTRN8TXc3gqg59AX-zN9HT6M7Uzzn~Iy~v9LLZnkE4CmzLCiE9YzpJpOSQfK6W462dFOF~6zyX2qR1kIQAAhLhOhlMUwHf0vY6VYH0jPdfJRDebSEvWbV8OkE9BQy5m9SpQug4yHu6jWRbE0UGKn~95-Mfj38A8BT~bZDDsEB5rOscf2VcvqkyeIlMLWBkAWzBQSVXLN0gwkOTIw76PSbo18X4P2Qo27OuKHvTcqPyLbRoxt~DHhpQ__",
            objectives: [
                "Brand Identity Development",
                "User Experience (UX) Design",
                "User Interface (UI) Design",
