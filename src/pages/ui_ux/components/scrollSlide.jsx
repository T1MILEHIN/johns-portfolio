...
const ScrollSlide = () => {
    ...
    return (
        <div ref={targetRef} className="relative flex items-center h-[200vh] py-0 overflow-hidden">
            <div className="sticky top-0 overflow-hidden flex items-center h-screen">
                <div className="flex flex-col gap-5 w-full">
                    <motion.div style={{ x: smoothX }} className="flex gap-5">
                        {videos.slice(0, 5).map((vid) => (
                            <div key={vid.id} className="relative min-w-[420px] h-[300px] bg-black rounded-md">
