    ...
    <div ref={footerRef} className="pt-56 lg:pt-36 relative">
      ...
      <div className="md:px-20">
        <div className="md:py-20 md:p-0 p-7">
          <h1 className="lg:w-[842px] w-full text-[40px] font-medium leading-[64px] font-specify_exp_med">Helping Brands Stand Out with Unique Design</h1>
        </div>
        <hr className="border-[#636363]" />
      </div>
      <div className="flex flex-wrap md:flex-nowrap gap-10 md:p-20 p-7">
        <motion.div initial={{x: -300, opacity: 0}} whileInView={{x:0, opacity: 1}} viewport={{ once: true, amount: 0.5}} transition={{ type: "spring"}} className="flex-1 flex flex-col gap-10 text-[#2E2A2A]">
        ...
        <motion.div initial={{x:300, opacity: 0}} whileInView={{x:0, opacity: 1}} viewport={{once: true, amount: 0.5}}  transition={{ type: "spring", delay: 0.2}} className="flex-1">
          <img src={img} alt="" />
        </motion.div>
      </div>
      ...
      <div className="md:p-20 p-4 relative bg-white">
        ...
        <motion.div className=" relative py-16 flex flex-wrap md:flex-nowrap gap-24 md:gap-10">
          <motion.div className="relative flex flex-col gap-5">
            ...
            <motion.p initial={{y:300}} whileInView={{y:0}} viewport={{once: true}} transition={{ type: "spring"}} className="font-bold absolute -bottom-40 text-[212px] text-[#63636386]">01</motion.p>
          </motion.div>
          <motion.div className="origin-center relative flex flex-col gap-5">
            ...
            <motion.p initial={{y:300}} whileInView={{y:0}} viewport={{once: true}} transition={{  type: "spring", delay: 0.2}} className="font-bold absolute -bottom-40 text-[212px] text-[#63636386]">02</motion.p>
          </motion.div>
          <motion.div className="relative flex flex-col gap-5">
            ...
            <motion.p initial={{y:300}} whileInView={{y:0}} viewport={{once: true}} transition={{ type: "spring", delay: 0.4}} className="font-bold absolute -bottom-40 text-[212px] text-[#63636386]">03</motion.p>
          </motion.div>
        </motion.div>
      </div>
