  ...
  return (
    <>
      <ReactLenis root options={{
        ...
        <NavBar />
        <motion.div style={{ borderBottomRightRadius: smoothRadius, borderBottomLeftRadius: smoothRadius }} className={`${(location.pathname === "/contact" || location.pathname === "/graphics") ? "bg-darkbg" : location.pathname === "/about" ? "bg-white" : "bg-bodybg"} relative z-[99] pb-20`}>
